...
const MinimalHeader: React.FC<MinimalHeaderProps> = ({ language, setLanguage, darkMode, setDarkMode, onReset }) => {
  return (
    <header className="fixed top-0 left-0 w-full z-40 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md shadow-sm flex items-center justify-between px-4 py-2">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mx-auto select-none">Dreamy Quiz</h1>
